...
def generate_synthetic_reviews(input_file, output_file):
    ...
    print("- reviewer_paper_properties.csv")
...
def synthetic_data():
    ...
    generate_synthetic_reviews('data/neo4j_import/reviewer_paper_relations.csv', 'data/neo4j_import/reviewer_paper_properties.csv')
